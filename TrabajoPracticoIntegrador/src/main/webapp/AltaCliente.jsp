...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="#">
    <img src="Imagenes/Bancoicon.png" width="100" height="80" class="d-inline-block align-center" alt=""> &nbsp;Menu Principal
  </a>
  <a class="navbar-brand" data-toggle="modal" href="#" data-target="#ModalCerrarSession">
    <img src="Imagenes/UserLog.png" width="80" height="80" class=" align-right" alt="">&nbsp;<strong>Nombre De Usuario</strong>
  </a>
</nav>
	   ...
	   <div class="container-fluid">
		...
		<div class="col">
			 <div class="form-group"> <!-- DNI -->
		        ...
		        <input type="number" class="form-control" id="full_name_id" name="full_name" placeholder="D.N.I">
		    </div>  
		    <div class="form-group"> <!-- Nombre -->
		        <label for="full_name_id" class="control-label">Nombre</label>
		        <input type="text" class="form-control" id="full_name_id" name="full_name" placeholder="NOMBRE">
		    </div>    
		    <div class="form-group"> <!-- Apellido -->
		        <label for="full_name_id" class="control-label">Apellido</label>
		        <input type="text" class="form-control" id="full_name_id" name="full_name" placeholder="APELLIDO">
		    </div> 
		    ...
		    <div class="form-group"> <!-- Nacionalidad -->
		        ...
		        <input type="text" class="form-control" id="full_name_id" name="full_name" placeholder="NACIONALIDAD">
		    </div> 
		</div>
		<div class="col">
		   ...
		   <div class="form-group"> <!-- Direccion -->
		        ...
		        <input type="text" class="form-control" id="full_name_id" name="full_name" placeholder="DIRECCION">
		    </div>
		            
		    <div class="form-group"> <!-- Localidad -->
		        <label for="full_name_id" class="control-label">Localidad</label>
		        <input type="text" class="form-control" id="full_name_id" name="full_name" placeholder="LOCALIDAD">
		    </div>                
