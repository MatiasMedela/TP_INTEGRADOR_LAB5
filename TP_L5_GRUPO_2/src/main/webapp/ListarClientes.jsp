		     	...
		     	<td class="text-center">
					<c:choose>
					    <c:when test="${Cliente.isEstado()==true}">
						    <input type="button" class="btn-sm btn-success btn-grid-action" name="BtnBajaClie" 
					     	value="Alta"  onclick="return PasarDniBaja(${ Cliente.getDni()})"/>
					    </c:when>    
					    <c:otherwise>
					       <input type="button" class="btn-sm  btn-danger btn-grid-action" name="BtnAltaClie" 
		     				value="Baja"  onclick="return PasarDniAlta(${ Cliente.getDni()})"/>
					    </c:otherwise>
					</c:choose>
		     	</td>
			 </tr>
...
<form action="RedireccionarDarDeBajaCliente.html" method="post" id="BajaClienteId" accept-charset=utf-8></form>
<!-- form Dar de alta cliente  -->
 <form action="RedireccionarDarDeAltaCliente.html" method="post" id="AltaClienteId" accept-charset=utf-8></form>
